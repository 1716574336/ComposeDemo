...
import com.cenming.composedemo.model.Markup
import com.cenming.composedemo.model.MarkupType
import com.cenming.composedemo.model.Metadata
import com.cenming.composedemo.model.Paragraph
import com.cenming.composedemo.model.ParagraphType
import com.cenming.composedemo.model.Post
import com.cenming.composedemo.model.PostAuthor
import com.cenming.composedemo.model.Publication
...
val paragraphsPost2 = listOf(
    ...
    Paragraph(
        ParagraphType.Text,
        "Alternatively, if you use Kotlin DSL script files, include them like this in the build.gradle file of the modules that use Dagger:",
